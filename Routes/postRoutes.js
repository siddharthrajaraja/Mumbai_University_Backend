    ...
    bcrypt.genSalt(saltRounds,(err,salt)=>{
        bcrypt.hash(req.body.password,salt,(err,hash)=>{
            ...
            studentModel.findOne({email:req.body.email},(err,data)=>{
                if(err) throw err;
                if(data==null){ studentModel(req.body).save(()=>{console.log("Object added");res.send("Aaa gaay bc");mail('darkp251099@gmail.com',req.body.email,'Verification','Click the given link to verify your email',`<a href='http://mugs-web-portal/login'>Click Here!</a>`)})}
